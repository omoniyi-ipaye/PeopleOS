...
export function EmptyState({
  ...
  return (
    <Surface tone={tone} className="flex min-h-64 flex-col items-center justify-center text-center">
      {icon && <div className="mb-4 grid h-12 w-12 place-items-center rounded-2xl bg-white/70 text-slate-600 shadow-sm dark:bg-white/5 dark:text-slate-300">{Icon ? <Icon className="h-5 w-5" /> : icon}</div>}
