  ...
  return (
    <ResponsiveContainer width="100%" height={350}>
      <BarChart data={chartData} layout="vertical" margin={{ top: 5, right: 30, left: 100, bottom: 5 }}>
        ...
        <XAxis type="number" stroke="var(--chart-axis)" fontSize={12} tickFormatter={(value) => Number(value).toFixed(2)} />
        ...
        <Tooltip
          ...
          formatter={(value) => [Number(value).toFixed(3), 'Model importance units']}
        />
