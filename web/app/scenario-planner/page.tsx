...
interface ScenarioResult {
  provenance?: {generation: string; dataset_id?: string; current_fingerprint?: string; dataset_version?: number; source_name?: string; reporting_currency?: string}
  available: boolean
...
export default function ScenarioPlannerPage() {
  ...
  const reportingCurrency = snapshot?.reporting_currency ?? storedResult?.provenance?.reporting_currency
